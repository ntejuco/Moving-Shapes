 ...
 * @return toolsPanel  the Panel
 ...
 public JPanel setUpToolsPanel() {
  ...
  ImageIcon logoButtonIcon = createImageIcon("logo.gif");
  JComboBox shapesComboBox = new JComboBox(new ImageIcon[]{rectangleButtonIcon, logoButtonIcon});
  shapesComboBox.setToolTipText("Set shape");
  shapesComboBox.addActionListener( new ActionListener() {
   public void actionPerformed(ActionEvent e) {
    JComboBox cb = (JComboBox)e.getSource();
    //set the Current shape type based on the selection: 0 for rectangle, 1 for logo
  ...
  JComboBox pathComboBox = new JComboBox(new ImageIcon[] {fallingButtonIcon,boundaryButtonIcon});
  pathComboBox.setToolTipText("Set Path");
  pathComboBox.addActionListener( new ActionListener() {
   public void actionPerformed(ActionEvent e) {
    JComboBox cb = (JComboBox)e.getSource();
    //set the Current path type based on the selection from combo box: 0 for Boundary Path, 1 for boundary Path
  ...
  final JButton borderButton = new JButton("Border");
